...
import com.daniel.findword.database.StatDatabase;
import com.daniel.findword.entities.Statistics;
...
//            });
        ...
        share_btn.setOnClickListener(v -> {
            ...
            String body = "https://play.google.com/store/apps/details?id=com.daniel.findword";
            myIntent.putExtra(Intent.EXTRA_TEXT, body);
            startActivity(Intent.createChooser(myIntent, "FindWord"));
        });
                        ...
                        class NextTask extends AsyncTask<Void, Void, Void> {
                            ...
                            protected void onPostExecute(Void unused) {
                                ...
                                if (stats.getWords_number() % 10 == 0) {
                                    ...
                                    InterstitialAd.load(MainActivity.this, "ca-app-pub-3801792611280684/3636104439", adRequest,
